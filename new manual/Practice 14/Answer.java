...
public class Answer {
    ...
    public static void main(String [] args){
        ...
        System.out.println();
        System.out.println(checkEmail("kalinin2003@list.ru"));
        System.out.println(checkEmail("alex kalinin@gmail.com"));
        System.out.println(checkEmail("kalinin.@.gmail.com"));
        System.out.println(checkEmail("kalinin@gmail"));
        System.out.println(checkEmail("kalinin@g@mail.ru"));
        System.out.println();
